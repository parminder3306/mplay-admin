...
<?php include('modal_add.php'); ?>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
							...
							?>
								<tr>
								<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $i; ?></td>
								<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['category']; ?></td>
								...
								<td style="text-align:center; width:350px;">
									<a href="edit_category.php<?php echo '?action=category&id='.$id; ?>" class="btn btn-info">Edit</a>
								...
								<p><div style="font-size:larger;" class="alert alert-danger">Are you Sure you want Delete <b style="color:red;"><?php echo $row['category']; ?></b> Data?</p>
								</div>
								<hr>
								<div class="modal-footer">
								<button class="btn btn-inverse" data-dismiss="modal" aria-hidden="true">No</button>
								<a href="delete.php<?php echo '?action=category&id='.$id; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
								</tr>
